    ...
    <div>
      ...
      <Navbar bg="body" expand="lg" className="pad1">
          ...
          <div className="ex1 style2">
            This page explains the terms of use of Short URL, the user when
            using the shortener site is conditioned to the acceptance of the
          ...
          <div className="ex1 style2 mt-3 mb-3">
            All urls are checked and analyzed by our team, any shortened url
            that leads to the landing page that meets the above conditions can
            be deleted. If we notice any abusive behavior against our terms of
          ...
          <div className="ex1 style2">
            ...
            that the site or services are uninterrupted, secure or error-free.
            Due to a large number of emails received, we may not respond to all
            emails.
          </div>
          <div className="ex1 headingstyle style1 font-weight-bold mb-2">
            Terms Updates
          ...
          <div className="ex1 style2 mb-5">
            Short URL reserves the right to update or change these terms of use
            at any time. The most current version of the terms will be posted on
            this page.
          </div>
      </div>
